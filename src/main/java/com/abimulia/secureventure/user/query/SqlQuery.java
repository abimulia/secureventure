...
public class SqlQuery {
    ...
    public static final String DELETE_VERIFICATION_CODE_BY_USER_ID = "DELETE FROM TwoFAVerifications WHERE user_id = :userId";
    ...
    public static final String UPDATE_USER_DETAILS_QUERY = "UPDATE Users SET first_name = :firstName, last_name = :lastName, email = :email, phone = :phone, address = :address, title = :title, bio = :bio WHERE user_id = :userId";
	...
	public static final String SELECT_ROLE_BY_ID_QUERY = "SELECT r.role_id, r.name, r.permissions FROM Roles r JOIN UserRoles ur ON ur.role_id = r.role_id JOIN Users u ON u.user_id = ur.user_id WHERE u.user_id = :userId";
	public static final String SELECT_ROLE_BY_EMAIL_QUERY = "SELECT r.role_id, r.name, r.permissions FROM Roles r JOIN UserRoles ur ON ur.role_id = r.id JOIN Users u ON u.user_id = ur.user_id WHERE u.email = :email";
