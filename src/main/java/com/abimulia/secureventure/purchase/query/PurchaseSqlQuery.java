...
public class PurchaseSqlQuery {
    ...
    public static final String UPDATE_PURCHASE_BY_ID_QUERY = "UPDATE PurchaseRequests SET productName=?,Date=?,productCode=? WHERE pr_id = :purchaserequestsId";
    public static final String DELETE_FROM_PURCHASE_BY_ID_QUERY = "DELETE FROM PurchaseRequests WHERE pr_id = :prId";
    public static final String SELECT_PURCHASE_REQUEST_BY_ID_QUERY = "SELECT * FROM PurchaseRequests WHERE pr_id = :prId";
